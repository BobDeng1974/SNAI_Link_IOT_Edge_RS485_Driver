    ...
    else//
    {
        ...
        case SNAI_TYPE_Co2:
            if(SNAI_ALL_DEVICE_REPORT.SNAI_DEVICE_EXIST[SNAI_all_device_value[3]] == 1)
            {
                ...
                SNAI_DEBUG_INFO("获取【%u#】二氧化碳值【%uppm】",SNAI_all_device_value[3],Current_Co2_value);//8#
				if(SNAI_Period_Set.SNAI_Main_Filtration_Flag == 0)
				{
                	SNAI_ALL_DEVICE_REPORT.SNAI_device_ready[SNAI_ALL_DEVICE_REPORT.SNAI_485dev_handle[SNAI_all_device_value[3]]] = 1;
				}
        ...
        case SNAI_TYPE_NH3:
            if(SNAI_ALL_DEVICE_REPORT.SNAI_DEVICE_EXIST[SNAI_all_device_value[3]] == 1)
            {
                ...
                SNAI_DEBUG_INFO("获取【%u#】氨气值【%uppm】",SNAI_all_device_value[3],Current_NH3_value);//9#
				if(SNAI_Period_Set.SNAI_Main_Filtration_Flag == 0)
				{
                	SNAI_ALL_DEVICE_REPORT.SNAI_device_ready[SNAI_ALL_DEVICE_REPORT.SNAI_485dev_handle[SNAI_all_device_value[3]]] = 1;
				}
        ...
        case SNAI_TYPE_Illumination:
            if(SNAI_ALL_DEVICE_REPORT.SNAI_DEVICE_EXIST[SNAI_all_device_value[3]] == 1)
            {
                ...
                SNAI_DEBUG_INFO("获取【%u#】光照值【%uLux】",SNAI_all_device_value[3],Current_light_intensity);//10#
				if(SNAI_Period_Set.SNAI_Main_Filtration_Flag == 0)
				{
                	SNAI_ALL_DEVICE_REPORT.SNAI_device_ready[SNAI_ALL_DEVICE_REPORT.SNAI_485dev_handle[SNAI_all_device_value[3]]] = 1;}
				else
        ...
        case SNAI_TYPE_Co:
            if(SNAI_ALL_DEVICE_REPORT.SNAI_DEVICE_EXIST[SNAI_all_device_value[3]] == 1)
            {
                ...
                SNAI_DEBUG_INFO("获取【%u#】一氧化碳值【%uppm】",SNAI_all_device_value[3],Current_Co_value);//13#
				if(SNAI_Period_Set.SNAI_Main_Filtration_Flag == 0)
				{
                	SNAI_ALL_DEVICE_REPORT.SNAI_device_ready[SNAI_ALL_DEVICE_REPORT.SNAI_485dev_handle[SNAI_all_device_value[3]]] = 1;
				}
        ...
        case SNAI_TYPE_Negative_Pressure:
            if(SNAI_ALL_DEVICE_REPORT.SNAI_DEVICE_EXIST[SNAI_all_device_value[3]] == 1)
            {
                ...
                SNAI_DEBUG_INFO("获取【%u#】负压值【%uPa】",SNAI_all_device_value[3],Current_Negative_Pressure_value);//7#
				if(SNAI_Period_Set.SNAI_Main_Filtration_Flag == 0)
				{
                	SNAI_ALL_DEVICE_REPORT.SNAI_device_ready[SNAI_ALL_DEVICE_REPORT.SNAI_485dev_handle[SNAI_all_device_value[3]]] = 1;
...
void* TX_READ(void* data)
{
    ...
    unsigned char SNAI_485_ADDR = 0x00;//start_origin 0x02
    while(1)
    {
    	...
    	if(SNAI_Gateway_Power_Switch_Flag != 0)
    	{
	        ...
	        else
	        {
							if(TX_first_polling_flag != 0)
							{
									...
									//current_device_cunt -= 1;//去掉虚拟网关设备//轮寻0号地址则不用减
	  	    ...
	  	    SNAI_485_ADDR++;
		    SNAI_485_ADDR = (SNAI_485_ADDR > ALL_DEVICE_COUNT?0x00:SNAI_485_ADDR);
