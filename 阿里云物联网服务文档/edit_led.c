            ...
            else//第二个湿度参数或者流速参数的时候
            {
                    switch(RS485_ADDR)
                    {
                        ...
                        case 0x05:
                            ...
                            {
                                    //温度的超时检测结果
                                    SNAI_DEBUG_INFO("上次值【%u】",SNAI_ALL_DEVICE_REPORT.SNAI_485dev_Data_Filtration_Flag[RS485_ADDR]);
                                    if(SNAI_ALL_DEVICE_REPORT.SNAI_485dev_Data_Filtration_Flag[RS485_ADDR])
                                    {
